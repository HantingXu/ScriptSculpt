...
MStatus ScriptSculptCmd::doIt(const MArgList& args)
{
	...
	*/
	...
	cv::imwrite(path, previewImg);
	MGlobal::executeCommand("shelfButton -e -image \"C:/Users/2000/ScriptSculpt/img/bunny_font.jpg\" -width 150 -height 200 -manage 1 -visible 1 -style \"iconAndTextHorizontal\" -align \"left\" -scaleIcon previewImage;");
